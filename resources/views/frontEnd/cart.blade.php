                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        @foreach($cart_datas as $cart_data)
                            ...
                            ?>
                            <?php echo "<script>console.log('object', " . $cart_data  .")</script>" ?>
                            <tr>
                    ...
                    <div class="total_area">
                        <ul>
                            @if(Session::has('discount_amount_price'))
                                <li>Sub Total <span>IDR {{$total_price}}</span></li>
                                <li>Coupon Discount (Code : {{Session::get('coupon_code')}}) <span>IDR {{Session::get('discount_amount_price')}}</span></li>
                                <li>Total <span>IDR {{$total_price-Session::get('discount_amount_price')}}</span></li>
                            @else
                                <li>Total <span>IDR {{$total_price}}</span></li>
                            @endif
                        </ul>
